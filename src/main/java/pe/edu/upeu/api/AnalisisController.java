...
public class AnalisisController {
    ...
    public void guardarAnalisis(@ModelAttribute("modeloAnalisis") Analisis analisis, BindingResult result) {
        System.out.println("jose" + analisis);
        service.guardarAnalisis(analisis);
    }
