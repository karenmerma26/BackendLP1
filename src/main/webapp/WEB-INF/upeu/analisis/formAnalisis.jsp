...
<html>
    ...
    <body>
        <div>
            <c:url var="saveanalisisx"  value="guardarAnalisis" />
...
<html>
    ...
    <body>
        <div>
            ...
            <fm:form modelAttribute="modeloAnalisis" method="post" action="guardarAnalisis">
                <table>
                    <tr>
                        <td><fm:label path="estado">Motivo</fm:label> </td>
                        <td><fm:input path="estado" /></td>
                    </tr>
                    <tr>
                        <td><fm:label path="estado">Estado</fm:label> </td>
