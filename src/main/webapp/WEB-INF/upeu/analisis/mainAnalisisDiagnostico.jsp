...
<html>
  ...
  <body  class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
        ...
        <form  id="formBuscar" action="buscarAnalisisDiagnostico"  method="post" name="formBuscar" >
        ...
        <td>
            <input  type="button" value="Nuevo" onclick="document.location.href='/BackendUPeU/formAnalisisDiagnostico'" class="btn btn-success" >&nbsp;   
        </td>
        </tr>
        </table>
        </form>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                          <c:if test="${!empty ListaAnalisisDiagnostico}">
                            <table border="1">
                                <tr>
                                    <th>idAnalisis</th>
                                    <th>idPaciente</th>
                ...
                <c:forEach items="${ListaAnalisisDiagnostico}" var= "dato">   
                <tr>
                    ...
                    <td>
                        <a href="eliminarAnalisisDiagnostico?id=${dato.AnalisisDiagnostico}">Eliminar</a>&emsp14;                                        
                    </td>
                </tr>
                </c:forEach>
                            </table>
